...
# upstream   https://github.com/bzumhagen/ProxmoxVE.git (fetch)
# upstream   https://github.com/bzumhagen/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/bzumhagen/ProxmoxVE"
echo ""
