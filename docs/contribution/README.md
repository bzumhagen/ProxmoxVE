...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/bzumhagen/ProxmoxVE → Fork (top right)
...
git remote add upstream https://github.com/bzumhagen/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/bzumhagen/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/bzumhagen/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/bzumhagen/ProxmoxVE/discussions)
