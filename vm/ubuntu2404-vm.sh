...
# License: MIT
# https://github.com/bzumhagen/ProxmoxVE/raw/main/LICENSE
...
<div align='center'>
  ...
  <span style='margin: 0 10px;'>
    ...
    <a href='https://github.com/bzumhagen/ProxmoxVE' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>GitHub</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-comments fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/bzumhagen/ProxmoxVE/discussions' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Discussions</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-exclamation-circle fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/bzumhagen/ProxmoxVE/issues' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Issues</a>
  </span>
</div>
EOF
)
...
More info at https://github.com/bzumhagen/ProxmoxVE/discussions/272 \n"
