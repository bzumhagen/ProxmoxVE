#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/bzumhagen/ProxmoxVE/refs/heads/habitica-sh/misc/build.func)
# Copyright (c) 2021-2025 community-scripts ORG
# Author: Slaviša Arežina (tremor021)
# License: MIT | https://github.com/community-scripts/ProxmoxVE/raw/main/LICENSE
# Source: https://github.com/awinterstein/habitica

APP="Habitica-Self-Hosted"
...
function update_script() {
  ...
  if check_for_gh_release "habitica-self-hosted" "awinterstein/habitica"; then
    ...
    fetch_and_deploy_gh_release "habitica-self-hosted" "awinterstein/habitica" "tarball" "latest" "/opt/habitica"
